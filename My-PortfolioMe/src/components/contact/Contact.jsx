...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_5bs33df', 'template_fucp3yq', form.current, {
        publicKey: 'nE3NAG6kyCobg4INW',
      })
      e.target.reset();
  };
  return (
            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">អង្គារ៉ា</span>
                        <a href="#" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                    </div>

                    <div className="contact_card">
                        <i className="bx bx-phone contact_card-icon"></i>
                        <h3 className="contact_card-title">Phone number</h3>
                        <span className="contact_card-data">090 234 532</span>
                        <a href="#" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                    </div>
                </div>
            </div>
            <div className="contact_content">
                ...
                <form className="contact_form" ref={form} onSubmit={sendEmail}>
                    ...
                    <div className="contact_form-div">
                        ...
                        <input type="email" name="email" className="contact_form-input" placeholder="Insert your name" />
                    </div>

                    <div className="contact_form-div">
                        <label className="contact_form-tag">Project</label>
                        <textarea name="project" className="contact_form-input" cols="30" rows="10" placeholder="Tell your project" />
                    </div>
